        ...
        float multiplication(float operand_1, float operand_2){
            ...
            float division(float operand_1, float operand_2){
                ...
                public static void main(String[] args){
                    ...
                    float operand_1=10;
                    float operand_2=5;git add
                    float add_result=calc.addition(operand_1,operand_2);
                    System.out.println("the result="+add_result);

                    float sub_result=calc.substraction(operand_1,operand_2);
                    System.out.println("the result="+sub_result);

                    float mul_result=calc.multiplication(operand_1,operand_2);
                    System.out.println("the result="+mul_result);

                    float div_result=calc.division(operand_1,operand_2);
                    System.out.println("the result="+div_result);
                }
}